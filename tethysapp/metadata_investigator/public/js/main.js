...
//function getMissingFields() {
//    const requiredIds = [
//        'metadata-id', 'title', 'abstract', 'metadata-date',
//        'scope-level', 'lineage-summary', 'process-step',
//        'geographic-description', 'code', 'west', 'east', 'north', 'south',
//        'org-name', 'telephone', 'address1', 'zipcode'
//    ];
//
//    let missingFields = [];
//    requiredIds.forEach(id => {
